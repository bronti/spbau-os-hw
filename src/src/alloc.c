...
volatile struct spinlock mem_lock = {UNLOCKED};
// volatile struct spinlock mem_cache_lock = {UNLOCKED};
...
void *mem_alloc(size_t size)
{
	...
	if (cache) return mem_cache_alloc(cache);
